...
# GBIF taxon key for Budorcas taxicolor (takin)
taxon_key = 2441046
limit = 300  # Number of records per request
offset = 0  # Starting offset
all_records = []

print("Fetching data from GBIF API for takin (Budorcas taxicolor)...")
...
# Save to CSV
csv_filename = "Budorcas_taxicolor_gbif_occurrences_full.csv"
