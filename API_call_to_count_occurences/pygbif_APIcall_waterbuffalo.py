...
# GBIF taxon key for bubalus_bubalis (Water buffalo)
taxon_key = 7422937
limit = 300  # Number of records per request
offset = 0  # Starting offset
all_records = []

print("Fetching data from GBIF API for water buffalo (bubalus_bubalis)...")
...
# Save to CSV
csv_filename = "bubalus_bubalis_gbif_occurrences_full"
